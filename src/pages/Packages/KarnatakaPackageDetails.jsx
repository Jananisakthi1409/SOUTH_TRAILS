// src/pages/Packages/KarnatakaPackageDetails.jsx
import { useState } from "react";
import { useParams, useNavigate } from "react-router-dom";
import { useAuthContext } from "../../features/auth/AuthContext";
import { motion } from "framer-motion";
import karnatakaPackages from "./karnatakaPackageData";
...
const KarnatakaPackageDetails = () => {
  ...
  const pkg = karnatakaPackages.find((p) => p.id === packageId);
  ...
  if (!pkg) {
    return (
      <div className="package-not-found">
        ...
        <button onClick={() => navigate("/karnataka-packages")}>Back to Packages</button>
      </div>
    );
  }
  ...
  return (
    <div className="kapd-page">
      {/* Hero Gallery */}
      <section className="kapd-hero-gallery">
      ...
      <div className="kapd-container">
        <div className="kapd-content">
          {/* Package Overview */}
          <section className="kapd-overview">
          ...
          {/* Places Covered */}
          <section className="kapd-section">
        ...
        <aside className="kapd-sidebar">
          <div className="booking-card">
            ...
            <div className="booking-form">
              ...
              <button className="back-btn" onClick={() => navigate("/karnataka-packages")}>
                Back to Packages
              </button>
            </div>
