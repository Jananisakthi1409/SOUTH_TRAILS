// src/pages/Packages/AndhraPradeshPackages.jsx
...
const destinationImages = Object.entries(imageModules)
  ...
  .reduce((map, [path, moduleValue]) => {
    ...
    const match = normalized.match(/andhra\/([^/]+)\/[^/]+\.(webp|avif)$/i);
    if (!match) return map;
...
const AndhraPradeshPackages = () => {
  ...
  // Filter packages
  const filteredPackages = andhraPradeshPackages.filter((pkg) => {
  ...
  return (
    <div className="andhra-packages-page">
      {/* Hero Section */}
      <section className="aap-hero">
        ...
        <div className="hero-content">
          ...
          >
            Andhra Pradesh Travel Packages
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Explore handpicked experiences across Andhra Pradesh
          </motion.p>
        </div>
      </section>

      {/* Filters Section */}
      <section className="aap-filters-section">
        <div className="aap-container">
          ...
          <div className="results-count">
            ...
            <strong>{andhraPradeshPackages.length}</strong> packages
          </div>
        </div>
      </section>
    ...
    >
      ...
      <div className="card-info-section">
        ...
        <div className="card-footer">
          ...
          <Link to={`/andhra-package/${pkg.id}`} className="select-btn">
            View Details
          </Link>
        </div>
      </div>
