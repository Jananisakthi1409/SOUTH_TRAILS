...
const KeraPackageDetails = () => {
  ...
  if (!pkg) {
    return (
      <div className="package-not-found">
        ...
        <button onClick={() => navigate("/kerala-packages")}>Back to Packages</button>
      </div>
    );
  }
  ...
  return (
    <div className="kpd-page">
      {/* Hero Gallery */}
      <section className="kpd-hero-gallery">
      ...
      <div className="kpd-container">
        <div className="kpd-content">
          {/* Package Overview */}
          <section className="kpd-overview">
        ...
        <aside className="kpd-sidebar">
          <div className="booking-card">
            ...
            <div className="booking-form">
              ...
              <button className="back-btn" onClick={() => navigate("/kerala-packages")}>
                Back to Packages
              </button>
            </div>
