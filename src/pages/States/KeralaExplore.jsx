...
import c1 from "../state/kerala/culturesection/c1.webp";
import c2 from "../state/kerala/culturesection/c2.webp";
import c3 from "../state/kerala/culturesection/c3.webp";
import c4 from "../state/kerala/culturesection/c4.webp";
...
const cultureCards = [
  {
    ...
    image: c1,
    desc: "Experience serene houseboats, canals and village life.",
  },
  {
    title: "Kathakali & Culture",
    image: c2,
    desc: "Witness Kerala's vibrant dance forms and traditions.",
  },
  {
    title: "Kerala Cuisine",
    image: c3,
    desc: "Taste authentic sadya, seafood and traditional delicacies.",
  },
  {
    title: "Tea Hills & Beaches",
    image: c4,
    desc: "Explore Munnar's hills and Kerala's beautiful coastline.",
  },
];
...
const reviews = [
  {
    name: "Rahul M.",
    city: "Kochi",
    review: "The Alleppey houseboat stay was unforgettable.",
  },
  {
    name: "Divya P.",
    city: "Thrissur",
    review: "Munnar's landscapes were absolutely breathtaking.",
  },
  {
    name: "Ananya S.",
    city: "Bengaluru",
    review: "Perfect mix of nature, culture and relaxation.",
  },
];
const KeralaExplore = () => {
...
<p>
  Discover tranquil backwaters, lush hill stations, golden beaches and unforgettable experiences.
</p>
...
>
  <div style={{ textAlign: "center", marginBottom: "50px" }}>
   <h2>The Soul of Kerala</h2>

<p style={{ color: "#64748b" }}>
  God's Own Country where nature, wellness and culture blend beautifully.
</p>
  </div>
