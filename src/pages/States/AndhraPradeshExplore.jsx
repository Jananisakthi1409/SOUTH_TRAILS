...
const cultureCards = [
  {
    ...
    image: c1,
    desc: "Sacred temples, pilgrimage sites and spiritual architecture.",
  },
  {
    title: "Coastal Beauty",
    image: c2,
    desc: "Pristine beaches, seaside retreats and maritime culture.",
  },
  {
    title: "Valley Wonders",
    image: c3,
    desc: "Scenic valleys, tribal culture and natural landscapes.",
  },
  {
    title: "Culinary Traditions",
    image: c4,
    desc: "Spiced curries, seafood delicacies and authentic cuisine.",
  },
];
...
const reviews = [
  {
    name: "Suresh P.",
    city: "Hyderabad",
    review: "Tirupati temple visit was spiritually enriching and well-organized.",
  },
  {
    name: "Divya M.",
    city: "Bangalore",
    review: "Araku Valley trek exceeded all expectations with stunning views.",
  },
  {
    name: "Krishna R.",
    city: "Chennai",
    review: "RK Beach and Boraka were perfect for a relaxing getaway.",
  },
];

const AndhraPradeshExplore = () => {
      ...
      <main className="app-shell state-page">
        <section className="section state-hero">
          <div className="hero-copy">
            <p className="eyebrow accent-light">Andhra Pradesh</p>
            <h1>Explore Andhra Pradesh</h1>
            <p>No hero images found in src/pages/state/andhra/</p>
          </div>
        </section>
      </main>
    );
      ...
      <section className="andhra-hero">
        <div className="hero-shell">
          ...
          <div className="hero-copy hero-copy-fixed">
            <p className="eyebrow accent-light">Andhra Pradesh</p>
            <h1>Explore Andhra Pradesh</h1>
            <p>Discover sacred temples, coastal beaches, tribal valleys and culinary treasures.</p>
            <div className="hero-actions hero-actions-cta">
              <Link to="/andhra-packages" className="button button-primary">
                Explore Packages
              </Link>
              <Link to="/states/andhra-pradesh" className="button button-secondary">
                View Destinations
              </Link>
            </div>
          </div>
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "50px" }}>
          <h2 style={{ fontSize: "2.5rem" }}>
            The Spirit of Andhra Pradesh
          </h2>

          <p style={{ color: "#64748b" }}>
            A land of sacred temples, coastal beauty, valleys and culinary traditions.
          </p>
        </div>
      ...
      >
        ...
        >
          {[
            ...
            "Trek Through Araku Valley",
            "Relax at RK Beach",
            "Explore Boraka Wonders",
          ].map((title, index) => (
            <div
              key={title}
              style={{
...
export default AndhraPradeshExplore;
