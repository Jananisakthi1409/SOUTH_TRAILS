      ...
      <section style={{ backgroundColor: "#ffffff", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "48px 56px" }}>
        ...
        <div style={{ maxWidth: "390px", width: "100%", margin: "0 auto" }}>
          ...
          <div style={{ border: "1px solid #99f6e4", background: "#f0fdfa", borderRadius: 12, padding: 14, marginBottom: 18 }}>
            ...
            <p style={{ margin: 0, color: "#334155", fontSize: 13 }}>Email: {credentials.email}</p>
            <p style={{ margin: "2px 0 12px", color: "#334155", fontSize: 13 }}>Password: {credentials.password}</p>
          ...
          <form onSubmit={handleSignInSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <label style={{ display: "flex", flexDirection: "column", gap: "6px", fontSize: "12px", fontWeight: "800", color: "#334155", textTransform: "uppercase", letterSpacing: "0.03em" }}>
              ...
              <input
                ...
                style={{ width: "100%", padding: "12px 14px", boxSizing: "border-box", borderRadius: "8px", border: "1px solid #cbd5e1", fontSize: "14px", color: "#0f172a", outline: "none" }}
              />
            </label>
            ...
            <label style={{ display: "flex", flexDirection: "column", gap: "6px", fontSize: "12px", fontWeight: "800", color: "#334155", textTransform: "uppercase", letterSpacing: "0.03em" }}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{ width: "100%", padding: "12px 60px 12px 14px", boxSizing: "border-box", borderRadius: "8px", border: "1px solid #cbd5e1", fontSize: "14px", color: "#0f172a", outline: "none" }}
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} style={{ position: "absolute", right: "12px", top: "11px", border: "none", backgroundColor: "transparent", color: "#64748b", fontSize: "12px", fontWeight: "700", cursor: "pointer", padding: 0 }}>
          ...
          <div style={{ border: "1px solid #e2e8f0", borderRadius: "8px", padding: "12px 14px", marginTop: "28px", backgroundColor: "#f8fafc" }}>
            <span style={{ display: "block", fontSize: "11px", fontWeight: "800", color: "#334155", textTransform: "uppercase" }}>Protected admin access</span>
