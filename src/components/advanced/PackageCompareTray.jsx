    ...
    <section className="compare-tray advanced-panel">
      <div style={{ display: "flex", justifyContent: "space-between", gap: "1rem", alignItems: "center", marginBottom: "0.8rem" }}>
        <div>
          ...
          <p style={{ margin: "0.2rem 0 0", color: "#35705c" }}>Compare price, duration, rating, and best-for signals.</p>
        </div>
      ...
      <div className="compare-grid">
        {visible.map((pkg) => (
          <article key={pkg.id} className="compare-item">
            <h4 style={{ margin: "0 0 0.5rem", color: "#022c22" }}>{pkg.title}</h4>
            ...
            <p style={{ margin: "0 0 0.7rem", color: "#35705c" }}>{pkg.category}</p>
